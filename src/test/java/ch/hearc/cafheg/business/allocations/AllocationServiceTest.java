...
class AllocationServiceTest {
  ...
  public void getParentDroitAllocation_GivenParent1Active_ShouldReturnParent1() {
    ...
    Assertions.assertEquals("Parent1", result);
  }
  ...
  @Test
  public void getParentDroitAllocation_GivenBothParentsActiveAndParent1HigherSalary_ShouldReturnParent1() {
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("parent1ActiviteLucrative", true);
    parameters.put("parent2ActiviteLucrative", true);
    parameters.put("parent1Salaire", BigDecimal.valueOf(5000));
    parameters.put("parent2Salaire", BigDecimal.valueOf(3000));
  ...
  @Test
  public void getParentDroitAllocation_GivenBothParentsActiveAndParent2HigherSalary_ShouldReturnParent2() {
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("parent1ActiviteLucrative", true);
    parameters.put("parent2ActiviteLucrative", true);
    parameters.put("parent1Salaire", BigDecimal.valueOf(3000));
    parameters.put("parent2Salaire", BigDecimal.valueOf(5000));
