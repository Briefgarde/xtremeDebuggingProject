...
public class VersementMapper extends Mapper {
  ...
  Logger logger = LoggerFactory.getLogger(VersementMapper.class);
  ...
  public List<VersementAllocationNaissance> findAllVersementAllocationNaissance() {
    ...
    Connection connection = activeJDBCConnection();
      try {
        ...
        logger.debug("Result(s) found {}", resultSet.getFetchSize());
        ...
        logger.error("Error in findAllVersementAllocationNaissance", e);
  ...
  public List<VersementAllocation> findAllVersementAllocation() {
    ...
    try {
      ...
      logger.error("Error in findAllVersementAllocation", e);
      throw new RuntimeException(e);
    }
  }
  ...
  public List<VersementParentEnfant> findVersementParentEnfant() {
    ...
    try {
      ...
      logger.error("Error in findVersementParentEnfant", e);
      throw new RuntimeException(e);
    }
  }
  ...
  public List<VersementParentParMois> findVersementParentEnfantParMois() {
    ...
    try {
      ...
      logger.error("Error in findVersementParentEnfantParMois", e);
      throw new RuntimeException(e);
    }
  }
}
